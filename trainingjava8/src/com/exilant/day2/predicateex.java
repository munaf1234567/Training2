...
//	
	...
	List<Person> intlist1 = filteredlist2(plist,graterthan1);
	intlist1.forEach(System.out::println);
	
	System.out.println("-----------------------------------------");
List<Person> intlist2 = filteredlist2(plist,lessthen2);
	intlist2.forEach(System.out::println);
	
	
	System.out.println("-----------------------------------------");
Predicate<Person> comppre1=posno1.and(betrange1);
	
	List<Person> intlist3 = filteredlist2(plist,comppre1);
	intlist3.forEach(System.out::println);
